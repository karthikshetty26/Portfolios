 ...
 * - SSR-safe initialization with lazy initializer
 */
export default function ThemeToggleButton({ isMenuOpen }) {
  const [theme, setTheme] = useState(() => {
    // SSR fallback - will be hydrated with actual value from document
  ...
  useEffect(() => {
    // Listen for system theme changes (only when user hasn't set preference)
